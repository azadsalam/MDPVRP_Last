...
public class Scheme6_with_dynamic_penalty_factor implements GeneticAlgorithm
{
	...
	public Scheme6_with_dynamic_penalty_factor(ProblemInstance problemInstance) 
	{
		System.err.println("in scheme 6 - with dynamic penalty factor");
...
/*		Solver.HallOfShamePCSize = problemInstance.periodCount * problemInstance.customerCount *1/3;
	...
	public static double initialPenaltyFactor =  Double.NEGATIVE_INFINITY;
	public static int k;
	...
	public static void initialisePenaltyFactor(ProblemInstance pi) 
	{
		initialPenaltyFactor  = Math.sqrt(pi.customerCount*pi.vehicleCount*pi.periodCount); 
		state  = NEUTRAL;
...
//		Solver.routeTimePenaltyFactor = problemInstance.customerCount;
		...
		initialisePenaltyFactor(problemInstance);
