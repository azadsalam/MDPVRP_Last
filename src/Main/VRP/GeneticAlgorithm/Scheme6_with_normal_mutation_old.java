...
public class Scheme6_with_normal_mutation_old implements GeneticAlgorithm
{
	...
	public Scheme6_with_normal_mutation_old(ProblemInstance problemInstance) 
	{
...
/*		Solver.HallOfShamePCSize = problemInstance.periodCount * problemInstance.customerCount *1/3;
		...
		localImprovement = new LocalImprovementAll(localSearch);	
...
//				drawnIndividuals.add(population[0]);
		...
		if(Solver.showViz)Solver.visualiser.drawIndividual(population[0], "Final Best");
