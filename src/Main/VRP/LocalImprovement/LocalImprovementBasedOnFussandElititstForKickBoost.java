...
public class LocalImprovementBasedOnFussandElititstForKickBoost extends LocalImprovement 
{
	public LocalImprovementBasedOnFussandElititstForKickBoost(LocalSearch localSearch) 
	{
		super( localSearch);
